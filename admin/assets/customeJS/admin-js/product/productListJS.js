      ...
      if (data.length > 0) {
        ...
        for (var i = 0; i < data.length; i++) {
          ...
          html+='<tr>'+
            ...
            '<td id="quantity_'+data[i].product_id+'">'+data[i].quantity+'</td>'+ 
            '<td id="unit_name'+data[i].product_id+'">'+data[i].unit_name+'</td>'+ 
            '<td id="product_mrp_'+data[i].product_id+'"><i class="fa fa-rupee"></i> '+data[i].product_mrp+'</td>'+ 
            '<td id="retail_price_'+data[i].product_id+'"><i class="fa fa-rupee"></i> '+data[i].retail_price+'</td>'+  
            '<td id="wholesale_price_'+data[i].product_id+'"><i class="fa fa-rupee"></i> '+data[i].wholesale_price+'</td>'+ 
            '<td id="purchase_price_'+data[i].product_id+'"><i class="fa fa-rupee"></i> '+data[i].purchase_price+'</td>'+ 
            // '<td>'+
