          ...
          <section class="content">
            <div class="container-fluid">
              ...
              <div class="text-center" id="customer-status"></div>
               ...
               <select id="select_warehouse" class="col-sm-3 mb-2 form-control input-txt float-right">
                 <option selected value="">Select Warehouse</option>
                 
               </select>
              <span class="d-block medium-text">All Product List</span>
...
<!-- Custome JS --> 
<script src="<?php echo base_url()?>assets/customeJS/admin-js/product/productListJS.js"></script> 