...
<div class="login-box">
  <div class="login-logo">
    <!-- <img src="<?php //echo base_url()?>assets/Logo.png" class="logo-img"> -->
  </div>
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body">
      <div class="login-box-msg"><img height="150" src="<?php echo base_url(); ?>assets/dist/img/sidebar-logo/001.jpg"></div>
      ...
      <!-- <form action="" method="post"> -->
        ...
        <div class="row">
          <div class="col-12 text-center">
            <button id="submit" onclick="adminLogin()" name="submit" class="btn btn-lg btn-login text-white">Sign In</button>
          </div>
        </div>
      <!-- </form> -->
    </div>
...
<!-- Custome JS -->
<script src="<?php echo base_url()?>assets/customeJS/admin-js/adminLogin.js"></script>
<!-- Bootstrap 4 -->
