               ...
               <div class="w-100">
                  <div class="save-bx">
                     <div class="row">
                        ...
                        <div class="col-md-6"></div>
                        <div class="col-md-3">
                           <div class="save-btn"><a href="javascript::" id="save-product-order" onclick="save_product_order()">Save</a></div>
                        </div>
                     </div>
                  </div>
               </div>
...
$.ui.autocomplete.prototype._renderItem = function(table, item) {
  return $( "<tr class='ui-menu-item' role='presentation'></tr>" )
    ...
    .append( "<td >"+item.product_id+"</td>"+"<td>"+item.product_title+"</td>"+"<td>"+item.wholesale_price+"</td>" )
    .appendTo( table );
}; 
   ...
   if (item_code =='' || item_code ==undefined) {
    ...
    var index = $("table tbody tr:last-child").index();
        var row = '<tr id="tr_item'+i+'">' +
            ...
            '<td><select class="form-control tbl-fld2 select_unit" onchange="sumMyvalue('+i+')" id="select_unit'+i+'" ><option value="0">None</option>'+units+'</select></td>' +
            '<td><input type="text" class="form-control tbl-fld price" onkeyup="sumMyvalue('+i+')" id="price'+i+'" placeholder="Price"></td>' +
            '<td><input type="text" class="form-control tbl-fld discount" onkeyup="sumMyvalue('+i+')" id="discount'+i+'" placeholder="Percentage" value="0"></td>' +
            '<td><input type="text" class="form-control tbl-fld discount_price" onkeyup="sumMyvalue('+i+')" id="discount_price'+i+'" placeholder="Amount" value="0"></td>' +
