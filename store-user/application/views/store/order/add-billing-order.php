                     ...
                     <table class="table table-bordered">
                        ...
                        <tbody>
                           <tr id="tr_item">
                              ...
                              <td>
                                 <div class="form-group">
                                    <input class="form-control tbl-fld total_qty" oninput="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')"  type="text" id="qty" onkeyup="sumMyvalue()" placeholder="1">
                                 </div>
                              </td>
                              <td>
                                 <div class="form-group">
                              ...
                              <td>
                                 <div class="form-group">
                                    ...
                                    <input class="form-control tbl-fld price" id="price" onkeyup="sumMyvalue()" readonly type="text" placeholder="25">
                                    <!-- <input class="form-control tbl-fld mrp_price" id="mrp_price" onkeyup="sumMyvalue()" type="hidden" placeholder="25"> -->
                                 </div>
                              </td>
                              <td class="d-none">
                                 <div class="form-group">
                                    <input class="form-control tbl-fld discount d-none" onkeyup="sumMyvalue()" id="discount" type="text">
                                 </div>
                              </td>
                              <td class="d-none">
                                 <div class="form-group">
                                    <input class="form-control tbl-fld discount_price d-none" onkeyup="sumMyvalue()" id="discount_price" type="text">
                                 </div>
                              </td>
                              <td>
                                 <div class="form-group">
                     ...
                     <div class="row">
                        ...
                        <div class="col-md-4">
                           <div class="form-group row">
                              <label class="col-md-3 col-form-label text-right ln-ht-25">Apply Coupon</label>
                              <div class="col-md-7">
                           ...
                           <div class="form-group row">
                              <label id="referral-label" class="col-md-3 col-form-label text-right ln-ht-25">Apply Referral</label>
                              <div class="col-md-7">
               ...
               <div class="w-100">
                  <div class="save-bx">
                     <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="save-btn row float-right" > <a href="javascript::" class="btn btn-warning mr-1" onclick="save_product_order_confirm(3)">Hold</a> <a href="javascript::" id="save-product-order" onclick="save_product_order_confirm(1)">Save</a></div>
                        </div>
                     </div>
                  </div>
               </div>
   ...
   if (item_code =='' || item_code ==undefined) {
    ...
    var index = $("table tbody tr:last-child").index();
          var row = '<tr id="tr_item'+i+'">' +
            ...
            '<td><input type="hidden" name="perfect_price" id="perfect_price'+i+'"><input type="text" class="form-control tbl-fld price" readonly onkeyup="sumMyvalue('+i+')" id="price'+i+'" placeholder="Price"></td>' +
