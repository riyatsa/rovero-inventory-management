      ...
      <!-- <form action="" method="post"> -->
        ...
        <div class="row">
          <div class="col-12 text-center">
            <button id="submit" onclick="storeLogin()" name="submit" class="btn btn-login text-white">Login</button>
          </div>
        </div>
      <!-- </form> -->
    </div>
...
<!-- Custome JS -->
<script src="<?php echo base_url()?>assets/customeJS/store/storeLogin.js"></script>
<!-- Bootstrap 4 -->
