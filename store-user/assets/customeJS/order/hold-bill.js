...
function get_warehouse_product() {
  $.ajax({
    type  : 'ajax',
    url   : '?/StoreBilling/get_current_hold_bill',
    async : false,
    dataType : 'json',
...
function edit_store_bill(id){
  // alert("test")
  window.location.assign("?/StoreBilling/hold_sales_bill/"+id);
  // window.loaction = ;
}
...
function view_store_bill(id){
  ...
  $.ajax({
    ...
    success : function(data){ 
      ...
      html_header +='<tr>'
      // html_header +='<td style="font-family:Arial, Helvetica, sans-serif; font-size:14px; font-weight:bold; color:#000; padding:12px 7px 12px 7px; border-bottom:1px solid #000;">#</td>'
      html_header +='<td style="font-family:Arial, Helvetica, sans-serif; font-size:14px; font-weight:bold; color:#000; padding:12px 7px 12px 7px; border-bottom:1px solid #000;">Name</td>'
      html_header +='<td style="font-family:Arial, Helvetica, sans-serif; font-size:14px; font-weight:bold; color:#000; padding:12px 7px 12px 7px; border-bottom:1px solid #000;">Qty</td>'
      // html_header +='<td style="font-family:Arial, Helvetica, sans-serif; font-size:14px; font-weight:bold; color:#000; padding:12px 7px 12px 7px; border-bottom:1px solid #000;">Tax</td>'
      html_header +='<td style="font-family:Arial, Helvetica, sans-serif; font-size:14px; font-weight:bold; color:#000; padding:12px 7px 12px 7px; border-bottom:1px solid #000;">MRP</td>'
      html_header +='<td style="font-family:Arial, Helvetica, sans-serif; font-size:14px; font-weight:bold; color:#000; padding:12px 7px 12px 7px; border-bottom:1px solid #000;">Price</td>'
      html_header +='<td style="font-family:Arial, Helvetica, sans-serif; font-size:14px; font-weight:bold; color:#000; padding:12px 7px 12px 7px; border-bottom:1px solid #000;">Total</td>'
      html_header +='<td style="font-family:Arial, Helvetica, sans-serif; font-size:14px; font-weight:bold; color:#000; padding:12px 7px 12px 7px; border-bottom:1px solid #000;">Saving</td>'
      html_header +='</tr>'
      var j ;
      var price_total = 0;
      var saving_toal = 0;
      for (var i = 0; i < productDetails.length ; i++) {
        ...
        html_table_data +='<tr>'
         // html_table_data +='<td style="font-family:Arial, Helvetica, sans-serif; font-size:14px; color:#000; padding:7px 7px 7px 12px; border-bottom:1px solid #000;">'+j+'</td>'
         ...
         // html_table_data +='<td style="font-family:Arial, Helvetica, sans-serif; font-size:14px; color:#000; padding:7px 7px 7px 12px; border-bottom:1px solid #000;">'+gst[0]+'%</td>'
      ...
      // +parseFloat(price_semi_total).toFixed(2)+
        // html_total +='<td style="font-family:Arial, Helvetica, sans-serif; font-size:14px; color:#000; padding:7px 7px 7px 12px; border-bottom:1px solid #000; font-weight:bold;">&nbsp;</td>'
        html_total +='<td style="font-family:Arial, Helvetica, sans-serif; font-size:14px; color:#000; padding:7px 7px 7px 12px; border-bottom:1px solid #000; font-weight:bold;">Total</td>'
        html_total +='<td style="font-family:Arial, Helvetica, sans-serif; font-size:14px; color:#000; padding:7px 7px 7px 12px; border-bottom:1px solid #000; font-weight:bold;">'+total_quntity+'</td>'
        // html_total +='<td style="font-family:Arial, Helvetica, sans-serif; font-size:14px; color:#000; padding:7px 7px 7px 12px; border-bottom:1px solid #000; font-weight:bold;">&nbsp;</td>'
        html_total +='<td style="font-family:Arial, Helvetica, sans-serif; font-size:14px; color:#000; padding:7px 7px 7px 12px; border-bottom:1px solid #000; font-weight:bold;">&nbsp;</td>'
        html_total +='<td style="font-family:Arial, Helvetica, sans-serif; font-size:14px; color:#000; padding:7px 7px 7px 12px; border-bottom:1px solid #000; font-weight:bold;">&nbsp;</td>'
        html_total +='<td style="font-family:Arial, Helvetica, sans-serif; font-size:14px; color:#000; padding:7px 7px 7px 12px; border-bottom:1px solid #000; font-weight:bold;">₹ '+parseFloat(amount_semi_total).toFixed(2)+'(incl tax.)</td>'
        html_total +='<td style="font-family:Arial, Helvetica, sans-serif; font-size:14px; color:#000; padding:7px 7px 7px 12px; border-bottom:1px solid #000; font-weight:bold;">₹ '+saving_toal.toFixed(2)+'</td>'
      html_total +='</tr>'
      ...
      if(data.productData[0].point !='0') {
        ...
        // html_total +='<td style="font-family:Arial, Helvetica, sans-serif; font-size:14px; color:#000; padding:7px 7px 7px 12px; border-bottom:1px solid #000; font-weight:bold;">&nbsp;</td>'
        html_total +='<td style="font-family:Arial, Helvetica, sans-serif; font-size:14px; color:#000; padding:7px 7px 7px 12px; border-bottom:1px solid #000; font-weight:bold;">&nbsp;</td>' 
        html_total +='<td style="font-family:Arial, Helvetica, sans-serif; font-size:14px; color:#000; padding:7px 7px 7px 12px; border-bottom:1px solid #000; font-weight:bold;">Discount point</td>'
        html_total +='<td style="font-family:Arial, Helvetica, sans-serif; font-size:14px; color:#000; padding:7px 7px 7px 12px; border-bottom:1px solid #000; font-weight:bold;">- ₹ '+parseFloat(data.productData[0].point).toFixed(2)+'</td>'
        html_total +='<td style="font-family:Arial, Helvetica, sans-serif; font-size:14px; color:#000; padding:7px 7px 7px 12px; border-bottom:1px solid #000; font-weight:bold;">&nbsp;</td>'
        html_total +='</tr>'
      }else{}
      ...
      if(data.productData[0].order_discounted_percentage !='0') { 
        ...
        // html_total +='<td style="font-family:Arial, Helvetica, sans-serif; font-size:14px; color:#000; padding:7px 7px 7px 12px; border-bottom:1px solid #000; font-weight:bold;">&nbsp;</td>'
        html_total +='<td style="font-family:Arial, Helvetica, sans-serif; font-size:14px; color:#000; padding:7px 7px 7px 12px; border-bottom:1px solid #000; font-weight:bold;">&nbsp;</td>' 
        html_total +='<td style="font-family:Arial, Helvetica, sans-serif; font-size:14px; color:#000; padding:7px 7px 7px 12px; border-bottom:1px solid #000; font-weight:bold;">Discount Price</td>'
        html_total +='<td style="font-family:Arial, Helvetica, sans-serif; font-size:14px; color:#000; padding:7px 7px 7px 12px; border-bottom:1px solid #000; font-weight:bold;">- ₹ '+parseFloat(total_disc).toFixed(2)+'</td>'
        html_total +='<td style="font-family:Arial, Helvetica, sans-serif; font-size:14px; color:#000; padding:7px 7px 7px 12px; border-bottom:1px solid #000; font-weight:bold;">&nbsp;</td>'
        html_total +='</tr>'
      }else{
        // html_total +='<tr>'
      ...
      //   html_total +='<td style="font-family:Arial, Helvetica, sans-serif; font-size:14px; color:#000; padding:7px 7px 7px 12px; border-bottom:0px solid #000; font-weight:bold;">&nbsp;</td>'
      //   html_total +='<td style="font-family:Arial, Helvetica, sans-serif; font-size:14px; color:#000; padding:7px 7px 7px 12px; border-bottom:0px solid #000; font-weight:bold;">&nbsp;</td>'
      //   html_total +='<td style="font-family:Arial, Helvetica, sans-serif; font-size:14px; color:#000; padding:7px 7px 7px 12px; border-bottom:1px solid #000; font-weight:bold;">Total Amount</td>'
      //   html_total +='<td style="font-family:Arial, Helvetica, sans-serif; font-size:14px; color:#000; padding:7px 7px 7px 12px; border-bottom:1px solid #000; font-weight:bold;">₹ '+parseFloat(data[0][0].total).toFixed(2)+'</td>'
      //   html_total +='<td style="font-family:Arial, Helvetica, sans-serif; font-size:14px; color:#000; padding:7px 7px 7px 12px; border-bottom:0px solid #000; font-weight:bold;">&nbsp;</td>'
      // html_total +='</tr>'
      ...
      html_total +='<tr>'
        ...
        html_total +='<td style="font-family:Arial, Helvetica, sans-serif; font-size:14px; color:#000; padding:7px 7px 7px 12px; border-bottom:0px solid #000; font-weight:bold;">&nbsp;</td>'
        html_total +='<td style="font-family:Arial, Helvetica, sans-serif; font-size:14px; color:#000; padding:7px 7px 7px 12px; border-bottom:1px solid #000; font-weight:bold;">Total Amount</td>'
        html_total +='<td style="font-family:Arial, Helvetica, sans-serif; font-size:14px; color:#000; padding:7px 7px 7px 12px; border-bottom:1px solid #000; font-weight:bold;">₹ '+Math.round(parseFloat(data.productData[0].total).toFixed(2))+'</td>'
        html_total +='<td style="font-family:Arial, Helvetica, sans-serif; font-size:14px; color:#000; padding:7px 7px 7px 12px; border-bottom:0px solid #000; font-weight:bold;">&nbsp;</td>'
      html_total +='</tr>'
      ...
      html_total +='<tr>'
        ...
        html_total +='<td style="font-family:Arial, Helvetica, sans-serif; font-size:14px; color:#000; padding:7px 7px 7px 12px; border-bottom:1px solid #000; font-weight:bold;">CGST Amt</td>'
        html_total +='<td style="font-family:Arial, Helvetica, sans-serif; font-size:14px; color:#000; padding:7px 7px 7px 12px; border-bottom:1px solid #000; font-weight:bold;">SGST Amt</td>' 
        // html_total +='<td style="font-family:Arial, Helvetica, sans-serif; font-size:14px; color:#000; padding:7px 7px 7px 12px; border-bottom:1px solid #000; font-weight:bold;">&nbsp;</td>' 
        html_total +='<td style="font-family:Arial, Helvetica, sans-serif; font-size:14px; color:#000; padding:7px 7px 7px 12px; border-bottom:1px solid #000; font-weight:bold;">&nbsp;</td>' 
        html_total +='<td style="font-family:Arial, Helvetica, sans-serif; font-size:14px; color:#000; padding:7px 7px 7px 12px; border-bottom:1px solid #000; font-weight:bold;">&nbsp;</td>' 
        html_total +='<td style="font-family:Arial, Helvetica, sans-serif; font-size:14px; color:#000; padding:7px 7px 7px 12px; border-bottom:1px solid #000; font-weight:bold;">&nbsp;</td>' 
      ...
      html_total +='<tr>'
        ...
        html_total +='<td style="font-family:Arial, Helvetica, sans-serif; font-size:14px; color:#000; padding:7px 7px 7px 12px; border-bottom:1px solid #000; font-weight:bold;">₹ '+parseFloat(tax_price_semi_total/2) .toFixed(2)+'</td>'
        html_total +='<td style="font-family:Arial, Helvetica, sans-serif; font-size:14px; color:#000; padding:7px 7px 7px 12px; border-bottom:1px solid #000; font-weight:bold;">₹ '+parseFloat(tax_price_semi_total/2 ).toFixed(2)+'</td>' 
        // html_total +='<td style="font-family:Arial, Helvetica, sans-serif; font-size:14px; color:#000; padding:7px 7px 7px 12px; border-bottom:1px solid #000; font-weight:bold;">&nbsp;</td>' 
        html_total +='<td style="font-family:Arial, Helvetica, sans-serif; font-size:14px; color:#000; padding:7px 7px 7px 12px; border-bottom:1px solid #000; font-weight:bold;">&nbsp;</td>'
        html_total +='<td style="font-family:Arial, Helvetica, sans-serif; font-size:14px; color:#000; padding:7px 7px 7px 12px; border-bottom:1px solid #000; font-weight:bold;">&nbsp;</td>' 
        html_total +='<td style="font-family:Arial, Helvetica, sans-serif; font-size:14px; color:#000; padding:7px 7px 7px 12px; border-bottom:1px solid #000; font-weight:bold;">&nbsp;</td>' 
        if(data.productData[0].order_status == '1' || data.productData[0].order_status == '2' || data.productData[0].order_status == '3'){
        html_total +='<td id="canceled_invoice" style="font-family:Arial, Helvetica, sans-serif; font-size:14px; color:#000; padding:7px 7px 7px 12px; border-bottom:1px solid #000; font-weight:bold;">&nbsp;</td>'    
        }else{
        html_total +='<td id="canceled_invoice" class ="text-danger" style="font-family:Arial, Helvetica, sans-serif; font-size:14px; color:#000; padding:7px 7px 7px 12px; border-bottom:1px solid #000; font-weight:bold;">Canceled Invoice</td>'    
        }
