...
function get_warehouse_product() {
  $.ajax({
    type  : 'ajax',
    url   : '?/wareHouseProduct/get_warehouse_product',
    async : false,
    dataType : 'json',
      ...
      if (data.length > 0) {
        ...
        for (var i = 0; i < data.length; i++) {
          ...
          html+='<tr>'+
            ...
            '<td id="barcode_'+data[i].product_id+'"><i class="fa fa-rupee"></i> '+data[i].product_mrp+'</td>'+ 
            '<td id="barcode_'+data[i].product_id+'"><i class="fa fa-rupee"></i> '+data[i].retail_price+'</td>'+  
            '<td id="barcode_'+data[i].product_id+'"><i class="fa fa-rupee"></i> '+data[i].wholesale_price+'</td>'+ 
