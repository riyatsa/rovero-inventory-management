   ...
   <div class="content-wrapper">
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <label>
              <a href="/" class="header-left-tab-a">Warehouse-Users Panel / </a>
              <span class="header-left-tab-span">WareHouse Users</span>
            </label>
          </div>
        </div>
      </div>
    ...
    <section class="content">
      <div class="container-fluid"> 
          <span class="d-block medium-text">Add WareHouse Users</span>
         <div class="row mt-4">
                <div class="col-sm-6">
                  <label class="product-details-span-light">WareHouse Name</label>
                  <input type="text" class="input-txt mt-3" name="werehousename" id="werehousename" placeholder="Enter WareHouse User Name">
                  <div id="werehousename-error-msg-div"></div>
                </div>
                 <div class="col-sm-6">
                  <label class="product-details-span-light">WareHouse Role</label>
                  <select class="input-txt mt-3" id="w-role">
              ...
              <div class="row mt-2">
                ...
                <div class="col-sm-6">
                  ...
                  <input type="text" class="input-txt mt-3" name="w-email" id="w-email" placeholder="User Email">
                  <div id="w-email-error-msg-div"></div>
                </div>
                <div class="col-sm-6">
                  <label class="product-details-span-light">Enter Password</label>
                   <input type="password" class="input-txt mt-3" name="w-password" id="w-password" placeholder="Enter Your Password">
        ...
        <span class="d-block medium-text">All wharehouse users</span>
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
      <div class="modal-content modal-content-edit">
        <div class="modal-header border-0">
          <h4 class="modal-title-edit-coupon">Edit WareHouse User</h4>
        </div>
        ...
        <div class="modal-body modal-body-edit-coupon">
          <div class="row mt-4">
                <div class="col-sm-6">
                  ...
                  <input type="text" class="input-txt mt-3" name="edit-werehousename" id="edit-werehousename" placeholder="Enter WareHouse User Name">
...
<script src="<?php echo base_url()?>assets/customeJS/warehouse/users/add-warehouse-user.js"></script> 