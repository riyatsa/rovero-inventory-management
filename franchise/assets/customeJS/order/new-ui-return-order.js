    ...
    if (jQuery.inArray(selected_item_product_id, order_product_id_array) === -1) {
      ...
      $.ajax({
        ...
        success: function(data) {
          ...
          html += '</td>';
          html += '<td>';
          html += '<input type="hidden" class="order_item_code" id="item_code" value="'+data.barcode+'">';
          ...
          html += '<td class="d-none">';
          html += '<div class="form-group">';
          html += '<input class="form-control tbl-fld discount'+add_new_item_i+'" onkeyup="sumMyvalue('+add_new_item_i+')" id="discount" type="text">';
          html += '</div>';
          html += '</td>';
          html += '<td class="d-none">';
          html += '<div class="form-group">';
