      ...
      <div class="container-fluid">
        <div class="product-tabs-container">
          <ul class="nav nav-tabs" role="tablist"> 
           ...
           <li class="nav-item">
              <a class="nav-link active nav-link-product-tab"  href="?/StoreOrder/warehouse_approved_products">View Warehouse Approved Order</a>
            </li>
              <li class="nav-item">
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
      <div class="modal-content modal-content-edit">
        <div class="modal-header border-0">
          <h4 class="modal-title-edit-coupon">Are you sure want to Cancel this order ?</h4>
        </div> 
         
        <div class="modal-footer border-0" id="confirm-cancel">
...
<!-- View Purchase Order -->
<div class="modal fade" id="sales_order_View">
 ...
 <script src="<?php echo base_url()?>assets/customeJS/order/warehouse-approved-order.js"></script>