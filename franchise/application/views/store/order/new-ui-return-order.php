   ...
   <section class="content">
      <div class="container-fluid">
         <div class="product-tabs-container">
            ...
            <li class="nav-item">
              <a class="nav-link  nav-link-product-tab" href="#">Add Purchase Order</a>
            </li>  
            <li class="nav-item">
            ...
            <li class="nav-item">
             ...
             <li class="nav-item">
              <a class="nav-link active nav-link-product-tab" href="?/returnOrder" >Purchase Return Order</a>
            </li>
            <li class="nav-item">
            ...
            <div class="row">
               <div class="col-md-9">
                  ...
                  <div class="row lft-mar">
                     <div class="col-md-12">
                       <!--  <a href="#" class="view mt-3" data-toggle="modal" data-target="#view-all-items-modal">
                   ...
                   <!--   <div class="row mt-3">
                     ...
                     <div class="row tol-del mt-3">
                        ...
                        <div class="col-md-7 pl-0">
                           <input type="number"  min="0" oninput="this.value = Math.abs(this.value)"   onkeyup="paid_amounts()"  class="text-right" placeholder="0" value="0" id="paid_price">
...
<script src="<?php echo base_url()?>assets/customeJS/order/new-ui-return-order.js"></script>
