      ...
      <div class="container-fluid">
        <div class="product-tabs-container">
          <ul class="nav nav-tabs" role="tablist"> 
           ...
           <li class="nav-item">
              <a class="nav-link active nav-link-product-tab" href="?/StoreBilling/hold_bills" >View All Hold Order</a>
            </li>
          </ul>
          <section class="content">
            <div class="container-fluid">
...
function printDiv() 
{
 ...
 <script src="<?php echo base_url()?>assets/customeJS/order/hold-bill.js"></script>