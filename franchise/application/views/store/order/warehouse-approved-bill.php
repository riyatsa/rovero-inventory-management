               ...
               <div class="container-fluid">
                  <div class="row">
                     <div class="col-md-4">
                           ...
                           <input type="hidden" name="purchase_id" value="<?php echo $order['sales_id']; ?>" id="purchase_id">
                     ...
                     <table class="table table-bordered">
                        <thead>
                           <tr>
                              ...
                              <th width="10%" rowspan="2" valign="middle" scope="col">Defferece</th>
                           ...
                           <tr id="tr_item<?php echo $i; ?>">
                              <td class="newtwo-bx">
                                 <div class="form-group">
                                  ...
                                  <input type="hidden" class="order_product_id" readonly value="<?php echo $prId; ?>" id="order_product_id<?php echo $i; ?>" >
                                    <input class="form-control tbl-fld order_item_name" id="item_name<?php echo $i; ?>" readonly value="<?php echo $product_name[$key]; ?>" type="text" onkeyup="sumMyvalue(<?php echo $i; ?>)" placeholder="Cheri">
                                 </div>
                               
                              </td>
                              <td>
                                 <div class="form-group">
                                    <input class="form-control tbl-fld order_item_code" type="text" readonly id="item_code<?php echo $i; ?>" value="<?php echo $row['barcode']; ?>" onkeyup="get_barcode_value()" onfocus="get_barcode_value()" placeholder="1234567">
                                 </div>
                              </td>
                              <td>
                                 <div class="form-group">
                                    <input class="form-control tbl-fld total_qty" type="text" id="qty<?php echo $i; ?>" readonly value="<?php echo $product_qty[$key]; ?>" onkeyup="sumMyvalue(<?php echo $i; ?>)" placeholder="1">
                                 </div>
                              </td> 
                               <td>
                                 <div class="form-group">
                                    <input class="form-control tbl-fld received_qty" type="text" id="received_qty<?php echo $i; ?>" onkeyup="sumMyvalue(<?php echo $i; ?>)"  value="0" placeholder="1">
                                 </div>
                              </td>
                  
                              <td>
                                 <div class="form-group">
                                    <input class="form-control tbl-fld price" readonly value="<?php echo isset($product_price[$key])?$product_price[$key]:0; ?>" id="price<?php echo $i; ?>" onkeyup="sumMyvalue(<?php echo $i; ?>)" type="text" placeholder="25">
                                 </div>
                              </td>
                       <!--        <td class="d-none">
                                 <div class="form-group">
                              ...
                              <td>
                                 <div class="form-group">
                                 	<input class="form-control tbl-fld2 main_gst" id="main_gst<?php echo $i; ?>" type="text" value="<?php echo isset($tax_persent[$key])?$tax_persent[$key]:0; ?>" readonly name="">
                                     
                                 </div>
                              </td>
                              <td>
                                 <div class="form-group">
                                    <input class="form-control tbl-fld gst_price" readonly onkeyup="sumMyvalue(<?php echo $i; ?>)" value="<?php echo $tax_price[$key]; ?>" type="text" id="gst_price<?php echo $i; ?>" placeholder="1.25">
                                 </div>
                              </td>
                              <td>
                                 <div class="form-group">
                                    <input class="form-control tbl-fld sub_amount" type="text" readonly value="<?php echo $amount[$key]; ?>" onkeyup="sumMyvalue(<?php echo $i; ?>)" id="total_price<?php echo $i; ?>" placeholder="26.25">
                                 </div>
                              </td>
                              <td>
                                 <div class="form-group">
                                    <input class="form-control tbl-fld defference" type="text" readonly value="0" onkeyup="sumMyvalue(<?php echo $i; ?>)" id="defference<?php echo $i; ?>" placeholder="26.25">
                                 </div>
                              </td>
                              <td>
                                 <!-- <a class="add" title="Add" data-toggle="tooltip"><i class="material-icons">&#xE03B;</i></a> -->
                                 <select class="form-control tbl-fld1 missing_broken_type" id="missing_broken_type<?php echo $i; ?>">
                     ...
                     <div class="row">
                        ...
                        <div class="col-md-3">
                           <div class="form-group row">
                              ...
                              <div class="col-md-9">
                                 <input type="text" readonly class="form-control tbl-fld3 text-right" id="main_total_amount" value="<?php echo $order['total']; ?>">
                              </div>
                           </div>
                           <div class="form-group row">
...
<script src="<?php echo base_url()?>assets/customeJS/order/store-purchase-order-approve.js"></script>
