      ...
      <div class="container-fluid">
        <div class="product-tabs-container">
          <ul class="nav nav-tabs" role="tablist"> 
            ...
            <li class="nav-item">
              <a class="nav-link active nav-link-product-tab" href="?/returnOrder/details" >View Purchase Return Order</a>
            </li>
          </ul>
          <section class="content">
            <div class="container-fluid">
...
<div class="modal fade" id="view_store">
 ...
 <script src="<?php echo base_url()?>assets/customeJS/order/return-order-view.js"></script>