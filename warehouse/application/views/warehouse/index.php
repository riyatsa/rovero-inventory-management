    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <label>
              <a href="<?php echo base_url()?>?/adminDashboard" class="header-left-tab-a">Home / </a>
      ...
      <div class="container-fluid">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-6">
                    ...
                    <span class="info-box-number"><i class="fa fa-rupee"></i><?php
                        $total = round($total_sales['total_sales'],2);
                        if($total!=''){
                          echo $total."/-";  
                        }else{
                          echo"0/-";  
          ...
          <div class="col-12 col-sm-6 col-md-4">
            <div class="info-box mb-4">
              ...
              <div class="info-box-content">
                <div class="row">
                  <div class="col-sm-6">
                    <span class="info-box-text" title="Purchase Order">Purchase Order</span>
                    <span class="info-box-number"><?php echo $warehouse_purchase_order;?></span>
                  </div>
                  <div class="col-sm-6">
                    <span class="info-box-text" title="Total Purchase">Total Purchase</span>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">Sales and purchase Bar Chart</h3>
              ...
              <div class="card-body">
                <div class="chart">
                  <canvas id="salesPurchaseBarChart" style="min-height: 250px; height: 250px; max-height: 500px; max-width: 100%;"></canvas>
                </div>
              </div>
              <!-- /.card-body -->
            </div>
  ...
  <!-- /.content-wrapper -->
  <script src="<?php echo base_url()?>assets/customeJS/kpi/warehouse-kpi.js"></script>
