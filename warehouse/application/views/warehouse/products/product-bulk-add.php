        ...
        <div class="row mb-2">
          <div class="col-sm-6">
            <label>
              ...
              <span class="header-left-tab-span">Product Bulk Upload</span>
            </label>
          </div>
        </div>
      </div>
               ...
               <div class="tab-pane fade show active" id="add-product-tab" role="tabpanel" aria-labelledby="custom-content-below-profile-tab">
                  <div class="row pt-4">
                     ...
                     <div class="col-sm-6 mt-4">
                       <form action="?/wareHouseProduct/importpreview" method="POST" enctype = "multipart/form-data">
                        <div class="form-group">
                           <label class="hdr-txt-dark">Import Excel</label>
                           <input class="form-control input-txt" type="file" id="import_excel" required name="files" accept=".xls, .xlsx" >
                           <div id="excel-error-msg-div"></div>
                        </div> 
                         <button class="btn btn-add btn-add-2 text-white mt-2" onclick="preview_excel()" id="import_excel_file_preview" name="import_excel_file"><i class="fa fa-eye"></i> Preview</button>
                       </form>
                     </div>
                  </div>
               </div>
  ...
  <div class="modal fade" id="product-preview"  tabindex="-1" >
        ...
        <div class="row">
         <div class="table-responsive" id="">
                <table class="table table-striped">
                  ...
                  <tbody class="" id="get-product-lists">
