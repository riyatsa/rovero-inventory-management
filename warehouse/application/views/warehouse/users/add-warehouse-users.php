      ...
      <div class="container-fluid"> 
         ...
         <div class="row mt-4">
                <div class="col-sm-6">
                  ...
                  <input type="text" class="input-txt" name="werehousename" id="werehousename" placeholder="Enter WareHouse User Name">
        ...
        <span class="d-block medium-text">All Warehouse Users</span>
