...
<!-- Custome JS --> 
<script src="<?php echo base_url()?>assets/customeJS/vendor-js/add-vendor-js.js"></script>
<script src="<?php echo base_url()?>assets/customeJS/vendor-js/vendorListJs.js"></script>