                     ...
                     <table class="table table-bordered">
                        <thead>
                           <tr>
                              ...
                              <th width="7%" rowspan="2" scope="col">Received Qty</th>
                              ...
                              <th width="7%" rowspan="2" scope="col">Missing / Broken</th>
                           </tr>
                           <tr>
                        ...
                        <tbody>
                          ...
                          /*$order_data = array(
                            ...
                            $received_qty = explode(',', $order['received_qty']);
                            $missing_broken_status = explode(',', $order['missing_broken_status']);
                                // $productId = array();
                            // return $amount;
                            $total = 0;
                            $qty = 0;
                            ...
                            $i = 1;
                              foreach ($product_id as $key => $prId) { 
                                ...
                                if ($prId !='' && $prId !='0') { 
                                  $amount_total = $product_price[$key] * $received_qty[$key];
                           ...
                           <tr id="tr_item<?php echo $i; ?>">
                              <td class="newtwo-bx">
                                 <div class="form-group">
                                  ...
                                  <input type="hidden" class="order_product_id" value="<?php echo $prId; ?>" id="order_product_id" >
                                    <input class="form-control tbl-fld order_item_name" readonly id="item_name" value="<?php echo $product_name[$key]; ?>" type="text" onkeyup="sumMyvalue()" placeholder="Cheri">
                                 </div>
                               
                              </td>
                              <td>
                                 <div class="form-group">
                                    <input class="form-control tbl-fld order_item_code" readonly type="text" id="item_code" value="<?php echo $row['barcode']; ?>" onkeyup="get_barcode_value()" onfocus="get_barcode_value()" placeholder="1234567">
                                 </div>
                              </td>
                                ...
                                <td>
                                 <div class="form-group">
                                    <input class="form-control tbl-fld total_qty" type="text" id="qty" value="<?php echo $product_qty[$key]; ?>" onkeyup="sumMyvalue()" placeholder="1">
                                 </div>
                              </td> 
                              <td>
                                 <div class="form-group">
                                    <input class="form-control tbl-fld received_qty" readonly type="text" id="received_qty" value="<?php echo $received_qty[$key]; ?>" onkeyup="sumMyvalue()" placeholder="1">
                                 </div>
                              </td> 
                   <!--            <td class="d-none">
                                 <div class="form-group">
                              ...
                              <td>
                                 <div class="form-group">
                                    <input class="form-control tbl-fld price" readonly value="<?php echo $product_price[$key]; ?>" id="price" onkeyup="sumMyvalue()" type="text" placeholder="25">
                                 </div>
                              </td>
                       <!--        <td class="d-none">
                                 <div class="form-group">
                              ...
                              <td>
                                 <div class="form-group">
                                  <input type="text" name="main_gst" id="main_gst" onclick="sumMyvalue()" value="<?php echo isset($tax_persent[$key])?$tax_persent[$key]:0; ?>" class="form-control tbl-fld2 main_gst" >
                              ...
                              <td>
                                 <div class="form-group">
                                    <input class="form-control tbl-fld gst_price" onkeyup="sumMyvalue()" value="<?php echo round($tax_price[$key],2); ?>" type="text" id="gst_price" placeholder="1.25">
                                 </div>
                              </td>
                              <td>
                                 <div class="form-group">
                                    <input class="form-control tbl-fld sub_amount" type="text" value="<?php echo $amount_total; ?>" onkeyup="sumMyvalue()" id="total_price" placeholder="26.25">
                                 </div>
                              </td>
                              <td>
                                 <!-- <a class="add" title="Add" data-toggle="tooltip"><i class="material-icons">&#xE03B;</i></a> -->
                                 <!-- <a class="delete" title="Delete" onclick="remove_tr(<?php echo $i; ?>)"><i class="material-icons">&#xE872;</i></a> -->
                                 <select class="form-control tbl-fld1 missing_broken_type" id="missing_broken_type">
                                   <?php
                                   $status = isset($missing_broken_status[$key])?$missing_broken_status[$key]:0;
                                   if ($status == '0') {
                                     echo "<option value='0'>Default</option><option value='1'>Missing</option><option value='2'>Broken</option>";
                                   }else if($status == '1'){
                                    echo "<option value='0'>Default</option><option selected value='1'>Missing</option><option value='2'>Broken</option>";
                                   }else{
                                    echo "<option value='0'>Default</option><option value='1'>Missing</option><option selected value='2'>Broken</option>";
                                   }
                                   ?>
                                 </select>
                              </td>
                     ...
                     <div class="row">
                        ...
                        <div class="col-md-3">
                           ...
                           <div class="form-group row">
                              ...
                              <div class="col-md-9">
                                 <input type="number" oninput="this.value = Math.abs(this.value)" class="form-control tbl-fld3 text-right" value="<?php echo $order['paid']; ?>" onkeyup="paid_amounts()" id="paid_price" value="0">
                              </div>
               ...
               <div class="w-100">
                  <div class="save-bx">
                     <div class="row">
                        ...
                        <div class="col-md-6"></div>
                        <div class="col-md-3">
                           <div class="save-btn"><a class="mr-2" href="?/SalesOrder/re_approve_details">Cancel</a><a href="javascript::" id="save-product-order" onclick="save_product_order_confirm()">Save</a></div>
                        </div>
                     </div>
                  </div>
               </div>
...
<script src="<?php echo base_url()?>assets/customeJS/sales/update-sales-order.js"></script>
