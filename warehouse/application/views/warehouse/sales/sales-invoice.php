...
<table width="1000" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td align="center" style="font-family:Arial, Helvetica, sans-serif; font-size:30px; line-height:70px; color:#fa423b; font-weight:bold;">Transfer Order</td>
  </tr>
  <tr>
  ...
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      foreach ($bill['product'] as $key => $value) {
        ...
        <td style="font-family:Arial, Helvetica, sans-serif; font-size:14px; color:#000; padding:7px 7px 7px 12px; border-bottom:1px solid #000;">₹ <?php echo round($value['product_amount'],2); ?></td>
      </tr>
      <?php
      }
      ?>
  ...
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        if( isset($bill['order_discounted_percentage']) && $bill['order_discounted_percentage'] !='0') { 
          $total_disc = round($bill['grand_total']-$bill['order_discounted_price'],2);
        ?>
         <tr>  
        <td style="font-family:Arial, Helvetica, sans-serif; font-size:14px; color:#000; padding:7px 7px;">Discount Price</td>
        <td style="font-family:Arial, Helvetica, sans-serif; font-size:14px; color:#000; padding:7px 7px; text-align:right;">₹ <?php echo $total_disc;?></td> 
        ...
        if ($bill['point'] !='0') {
          $point_total = round($total_disc - $bill['point'],2);
           ?>
        <tr> 
        <td style="font-family:Arial, Helvetica, sans-serif; font-size:14px; color:#000; padding:7px 7px;">Point</td>
        <td style="font-family:Arial, Helvetica, sans-serif; font-size:14px; color:#000; padding:7px 7px; text-align:right;"> ₹ - <?php echo $bill['point']; ?></td>
        <!-- <td>&nbsp;</td> -->
         </tr>
           <?php
        }else{
        ...
        <tr> 
        <td style="font-family:Arial, Helvetica, sans-serif; font-size:14px; color:#000; padding:7px 7px;">Total Amount</td>
        <td style="font-family:Arial, Helvetica, sans-serif; font-size:14px; color:#000; padding:7px 7px; text-align:right;">₹ <?php echo round($point_total,2); ?></td>
        <!-- <td>&nbsp;</td> -->
         </tr>
          <?php
        }else{
          ?>
            ...
            <?php
        $point_total = 0;
        if (isset($bill['point']) && $bill['point'] !='0') { 
       ...
       <!--  <tr>
        ...
        ?>
          ...
          <tr>
            ...
            <td style="font-family:Arial, Helvetica, sans-serif; font-size:14px; color:#fff; font-weight:bold; padding:7px 7px; background:#fa423b; text-align:right;">₹ <?php echo round($point_total,2); ?></td>
          </tr>
          <tr>
            <td style="font-family:Arial, Helvetica, sans-serif; font-size:14px; color:#000; padding:7px 7px;">Received</td>
            <td style="font-family:Arial, Helvetica, sans-serif; font-size:14px; color:#000; padding:7px 7px; text-align:right;">₹ <?= round($bill['paid'],2)?></td>
          </tr>
          <tr>
            ...
            <td style="font-family:Arial, Helvetica, sans-serif; font-size:14px; color:#000; padding:7px 7px; text-align:right; border-bottom:1px solid #CCC;">₹ <?= $bill['balance']?></td>
          </tr>
          <tr>
