               ...
               <div class="container-fluid">
                  <div class="row">
                     <div class="col-md-3"> 
                           ...
                           <input class="form-control" id="searchField" onkeyup="get_autocomplete()" onfocus="get_autocomplete()" onblur="get_autocomplete()" type="text" placeholder="Search Store">
                            <div id="searchField-error"></div> --> 
                        <div class="form-group mb-0" id="div-number">
                           <label class="tp-txt">Outlet / Customer </label>
                          <select class="form-control" id="bill-options">
                     ...
                     <div class="col-md-2">
                        ...
                        <label class="tp-txt">Sale Invoice Type</label>
                  ...
                  <div class="row">
                     ...
                     <div id="store-option">
                        <div class="form-group mb-0" id="div-number">
                           <label class="tp-txt">Outlet</label>
                          <input type="hidden" name="party_id" id="bill_state_id">
                      ...
                      <div id="customer-option" style="display: none;">
                          <div class="form-group mb-0" id="div-number">
                      ...
                      <div class="form-group mb-0" id="div-number">
                     <label class="tp-txt">GST Number</label>
                     <input type="test" class="form-control tp-fld" name="customer_gst_number" id="customer_gst_number" placeholder="Enter GST Number">
                     </div>
                     ...
                     <table class="table table-bordered">
                        ...
                        <tbody>
                           <tr id="tr_item">
                              ...
                              <td>
                                 <div class="form-group">
                                     <input type="text" name="main_gst" id="main_gst" onclick="sumMyvalue()" value="0" class="form-control tbl-fld2 main_gst" >
