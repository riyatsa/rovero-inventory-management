      ...
      <div class="container-fluid">
        <div class="product-tabs-container">
          ...
          <li class="nav-item d-none">
              <a class="nav-link active nav-link-product-tab" href="#" >View Re-Approve Sales Order</a>
            </li>
          </ul>
          <section class="content">
            <div class="container-fluid">
...
<!-- Vagar kam nu che  -->
            ...
            <tr>
             ...
             <tr>
            <td colspan="2" id="newWin_accept_reject"></td>
          </tr>
            <tr>
...
<script src="<?php echo base_url()?>assets/customeJS/sales/sales-order-list-approve.js"></script>
<script>
function printDiv() 
{
  $('#print_button').hide();
