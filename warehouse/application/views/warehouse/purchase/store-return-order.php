          ...
          <div class="col-sm-6">
            <label>
             <a href="<?php echo base_url()?>?/warehouse-panel" class="header-left-tab-a">Warehouse Panel / </a>
              <span class="header-left-tab-span">Return Purchase Order List</span>
            </label>
          </div>
        </div>
      </div>
        ...
        <div class="product-tabs-container">
          <ul class="nav nav-tabs" role="tablist"> 
            ...
            <li class="nav-item d-none">
              <a class="nav-link active nav-link-product-tab" href="?/PurchaseOrder/store_return_order" >Return Store Purchase Order</a>
            </li>
          </ul>
          <section class="content">
            <div class="container-fluid">
...
<div class="modal fade" id="view_store">
    <div class="modal-dialog modal-xl modal-dialog-centered">
      <div class="modal-content modal-content-edit">
        <div class="modal-header border-0">
          <h4 class="modal-title-edit-coupon">Return Purchase Store Order</h4>
        </div>
...
<!-- Custome JS --> 
<script src="<?php echo base_url()?>assets/customeJS/purchase-order/store-return-order.js"></script> 
<script>
