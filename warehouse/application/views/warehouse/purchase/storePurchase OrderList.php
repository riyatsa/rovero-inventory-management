      ...
      <div class="container-fluid">
        <div class="product-tabs-container">
          <ul class="nav nav-tabs" role="tablist"> 
            ...
            <li class="nav-item">
              <a class="nav-link active nav-link-product-tab" href="?/PurchaseOrder/purchsedetails" >Store Indent</a>
            </li>
...
<!-- Custome JS --> 
<script src="<?php echo base_url()?>assets/customeJS/purchase-order/storePurchaseOrderJS.js"></script> 
<script>
