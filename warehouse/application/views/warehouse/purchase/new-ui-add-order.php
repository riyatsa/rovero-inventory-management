                   ...
                   <!--   <div class="row mt-3">
                     ...
                     <div class="row tol-del mt-3">
                        ...
                        <div class="col-md-7 pl-0">
                           <input type="number" oninput="this.value = Math.abs(this.value)" min="0" class="text-right" onkeyup="paid_amounts()"  placeholder="0" value="0" id="paid_price">
...
<script src="<?php echo base_url()?>assets/customeJS/purchase-order/new-ui-new-order.js"></script>

<script>
   $(function() {
      $.ui.autocomplete.prototype._renderMenu = function(ul, items) {
         var self = this;
         ul.append("<table class='table-bordered w-100'><thead><tr><th>ID#</th><th>Product&nbsp;Name</th> </tr></thead><tbody></tbody></table>");
      ...
      $.ui.autocomplete.prototype._renderItem = function(table, item) {
         ...
         return $( "<tr class='ui-menu-item' role='presentation'></tr>" ).append( "<td >"+item.product_id+"</td>"+"<td>"+item.product_title+"</td>" ).appendTo( table);
      }; 
...
<script>
  ...
  function remove_tr(id='') {
   ...
   $('table').on('keypress', '.total_qty', function (e) {
      if (e.which === 13) { 
        // $(this).closest('tr').nextAll().eq(0).find('.price').focus()
   ...
   $('table').on('keypress', '.price', function (e) {
      if (e.which === 13) { 
        $("#selected-item-name").focus();
      }
   });
