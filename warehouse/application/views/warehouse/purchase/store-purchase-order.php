                              ...
                              <td class="newtwo-bx">
                                 <div class="form-group">
                                  ...
                                  <input type="hidden" class="order_product_id" value="<?php echo $prId; ?>" id="order_product_id" >
                                    <input class="form-control tbl-fld order_item_name" id="item_name" value="<?php echo $product_name[$key]; ?>" type="text" onkeyup="sumMyvalue()" placeholder="Cheri">
                                 </div>
                               
                              </td>
                              <td>
                                 <div class="form-group">
                                    <input class="form-control tbl-fld order_item_code" type="text" id="item_code" value="<?php echo $row['barcode']; ?>" onkeyup="get_barcode_value()" onfocus="get_barcode_value()" placeholder="1234567">
                                 </div>
                              </td>
                              <td>
                                 <div class="form-group">
                               ...
                               <td>
                                 <div class="form-group">
                                    <input class="form-control tbl-fld ptotal_qty" type="text" id="pqty" value="<?php echo $barcode['quantity']; ?>" readonly placeholder="1">
                                 </div>
                              </td>
                   <!--            <td class="d-none">
                                 <div class="form-group">
                              ...
                              <td>
                                 <div class="form-group">
                                    <input class="form-control tbl-fld price" value="<?php echo $product_price[$key]; ?>" id="price" onkeyup="sumMyvalue()" type="text" placeholder="25">
                                 </div>
                              </td>
                       <!--        <td class="d-none">
                                 <div class="form-group">
                              ...
                              <td>
                                 <div class="form-group">
                                    <input class="form-control tbl-fld gst_price" onkeyup="sumMyvalue()" value="<?php echo $tax_price[$key]; ?>" type="text" id="gst_price" placeholder="1.25">
                                 </div>
                              </td>
                              <td>
                                 <div class="form-group">
                                    <input class="form-control tbl-fld sub_amount" type="text" value="<?php echo $amount[$key]; ?>" onkeyup="sumMyvalue()" id="total_price" placeholder="26.25">
                                 </div>
                              </td>
                              <td>
                     ...
                     <div class="row">
                        ...
                        <div class="col-md-3">
                           ...
                           <div class="form-group row">
                              ...
                              <div class="col-md-9">
                                 <input type="text" class="form-control tbl-fld3 text-right" value="<?php echo $order['paid']; ?>" onkeyup="paid_amounts()" id="paid_price" >
                              </div>
...
<script src="<?php echo base_url()?>assets/customeJS/purchase-order/store-purchase-order.js"></script>
