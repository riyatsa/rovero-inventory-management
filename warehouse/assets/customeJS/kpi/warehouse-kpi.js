...
function get_total_sales() {
  ...
  $.ajax({
    url: base_url+"?/WareHouseDashboard/total_sales_order", 
    type: "POST",
    dataType : 'JSON',
    data: {
...
function get_average_order_value() {
  ...
  $.ajax({
    url: base_url+"?/WareHouseDashboard/average_sales_order", 
    type: "POST",
    dataType : 'JSON',
    data: {
      duration : total_sales_time
...
function get_total_purchase() {
  ...
  $.ajax({
    url: base_url+"?/WareHouseDashboard/total_purchase_order", 
    type: "POST",
    dataType : 'JSON',
    data: {
      duration : total_sales_time
...
function get_total_no_of_orders() {
  ...
  $.ajax({
    url: "?/WareHouseDashboard/get_total_no_of_orders", 
    type: "POST",
    dataType : 'JSON',
    data: {
...
function get_total_no_of_purchase_orders() {
  ...
  $.ajax({
    url: "?/WareHouseDashboard/get_total_no_of_purchase_orders", 
    type: "POST",
    dataType : 'JSON',
    data: {
      duration : no_of_orders_time
...
function get_top_selling_items() {
  ...
  $.ajax({
    url: "?/WareHouseDashboard/get_top_selling_items", 
    type: "POST",
    dataType : 'JSON',
    data: {
...
function get_total_order_returns() {
  ...
  $.ajax({
    url: "?/WareHouseDashboard/get_total_order_returns", 
    type: "POST",
    dataType : 'JSON',
    data: {
...
function get_sales_by_item_count() {
  ...
  $.ajax({
    url: "?/WareHouseDashboard/get_sales_by_item_count", 
    type: "POST",
    dataType : 'JSON',
    data: {
