...
// return false;
  ...
  $("#add_new_product_btn").prop('disabled',true);
    ...
    $.ajax({
        type: "POST",
          url: base_url+"?/PurchaseOrder/re_update_sales_order/"+sales_id,
          data:formdata,
          dataType: 'json',
          contentType: false,
          processData: false,
          success: function(data) {
            ...
            window.location = "?/SalesOrder/re_approve_details";
            }else{
